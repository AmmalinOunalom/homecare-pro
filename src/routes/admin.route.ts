...
import { sign_up_admin, sign_in_admin, forgot_password_admin, rename_admin, show_all_admins } from '../controllers/admin.controller';
...
router.get("/read_all_admins", show_all_admins);
 ...
 *         description: Internal server error
 */
router.post("/sign_up", sign_up_admin);
 ...
 *         description: Internal server error
 */
router.post("/sign_in", sign_in_admin);
 ...
 *         description: Internal server error
 */
router.post("/forgot-password", forgot_password_admin);
